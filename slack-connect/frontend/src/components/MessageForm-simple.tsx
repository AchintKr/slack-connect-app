      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            title="Choose a date and time to schedule your message"
            className="appearance-none w-full px-4 py-3 bg-pink-900/40 border border-pink-500/40 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition duration-200 [color-scheme:dark]"
          />
        </div>
